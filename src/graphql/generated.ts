...
export type GetQueryBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetQueryBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', id: string, title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', avatarURL: string, bio: string, name: string } | null } | null };
...
export const GetQueryBySlugDocument = gql`
...
/**
 * __useGetQueryBySlugQuery__
 *
 * To run a query within a React component, call `useGetQueryBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetQueryBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetQueryBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetQueryBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetQueryBySlugQuery, GetQueryBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetQueryBySlugQuery, GetQueryBySlugQueryVariables>(GetQueryBySlugDocument, options);
      }
export function useGetQueryBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetQueryBySlugQuery, GetQueryBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetQueryBySlugQuery, GetQueryBySlugQueryVariables>(GetQueryBySlugDocument, options);
        }
export type GetQueryBySlugQueryHookResult = ReturnType<typeof useGetQueryBySlugQuery>;
export type GetQueryBySlugLazyQueryHookResult = ReturnType<typeof useGetQueryBySlugLazyQuery>;
export type GetQueryBySlugQueryResult = Apollo.QueryResult<GetQueryBySlugQuery, GetQueryBySlugQueryVariables>;
